...
public class Cliente implements Serializable {
    ...
    private int id_cliente; //es el que genera la base de datos y no se verá en la interfaz gráfica
    ...
    public Cliente(int id_cliente,int num_cliente, String nombre_perro, String raza, String color, String alergico, String atencionEspecial, String nombre_duenio, String celular_duenio, String observaciones) {
